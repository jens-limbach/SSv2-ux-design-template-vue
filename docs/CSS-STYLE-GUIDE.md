...
#### 🔍 Search Icon
**Usage:** Search functionality, search buttons, search inputs
...
<svg class="sap-crm-icon sap-crm-icon--md" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" role="img" aria-label="plus">
  <path d="M12,4 C12.5523,4 13,4.51168 13,5.14285714 L13,11 L18.8571429,11 C19.4883429,11 20,11.4477 20,12 C20,12.5523 19.4883429,13 18.8571429,13 L13,13 L13,18.8571429 C13,19.4883429 12.5523,20 12,20 C11.4477,20 11,19.4883429 11,18.8571429 L11,13 L5.14285714,13 C4.51168,13 4,12.5523 4,12 C4,11.4477 4.51168,11 5.14285714,11 L11,11 L11,5.14285714 C11,4.51168 11.4477,4 12,4 Z" />
</svg>
```

#### ✕ Close Icon
**Usage:** Close dialogs, dismiss notifications, clear inputs
...
#### 📊 Analytics Icon
**Usage:** Analytics panels, charts, reporting features
...
<svg class="sap-crm-icon sap-crm-icon--md" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" role="img" aria-label="analytics">
  <path d="M12 2a1 1 0 011 1v18a1 1 0 11-2 0V3a1 1 0 011-1z M20.94 8.649a1 1 0 01-.585 1.287l-8.004 3a1 1 0 01-.702-1.872l8.004-3a1 1 0 011.287.585z M2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10S2 17.523 2 12zm10-8a8 8 0 100 16 8 8 0 000-16z" />
</svg>
```

#### 🔄 Unsorted Icon
**Usage:** Table column headers (default state), sortable indicators
...
#### ⬆️ Ascending Icon
**Usage:** Table sorting (ascending order)
...
#### ⬇️ Descending Icon
**Usage:** Table sorting (descending order)
...
#### 🔗 Open Page Icon
**Usage:** External links, open in new window/tab
...
| Icon | Name | Common Usage | Recommended Size |
|------|------|--------------|------------------|
| 🔍 | `search` | Search buttons, search inputs | `sm` or `md` |
| ➕ | `plus` | Add/create buttons | `sm` |
| ✕ | `close` | Close dialogs, clear inputs | `sm` |
| 🗑️ | `trash` | Delete actions | `sm` or `md` |
| 📊 | `analytics` | Analytics panels, reports | `md` or `lg` |
| 🔄 | `unsorted` | Default table sort state | `sm` |
| ⬆️ | `ascending` | Ascending sort indicator | `sm` |
| ⬇️ | `descending` | Descending sort indicator | `sm` |
| ✏️ | `edit` | Edit actions | `sm` or `md` |
| 🔗 | `open-page` | External links | `sm` or `md` |
